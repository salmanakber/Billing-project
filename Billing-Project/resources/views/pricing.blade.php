            ...
            <div class="card border rounded shadow-none">
              <div class="card-body">
                <div class="my-3 pt-2 text-center">
                  <img
                    src="{{asset('img/illustrations/page-pricing-basic.png')}}"
                    alt="Basic Image"
                    height="140"
                  />
                </div>
          ...
          <div class="col-lg mb-md-0 mb-4">
            <div class="card border-primary border shadow-none">
              <div class="card-body position-relative">
                ...
                <div class="my-3 pt-2 text-center">
                  <img
                    src="{{asset('img/illustrations/page-pricing-standard.png')}}"
                    alt="Standard Image"
                    height="140"
                  />
                </div>
          ...
          <div class="col-lg">
            <div class="card border rounded shadow-none">
              <div class="card-body">
                <div class="my-3 pt-2 text-center">
                  <img
                    src="{{asset('img/illustrations/page-pricing-enterprise.png')}}"
      ...
      <div class="container">
        <div class="position-relative">
          ...
          >
            ...
            <div class="text-center">
              <img
                src="{{asset('img/illustrations/girl-with-laptop.png')}}"
